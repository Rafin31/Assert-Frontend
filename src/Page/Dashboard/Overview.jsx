...
export default function Overview() {
    ...
    useEffect(() => {
        const fetchTokenBalance = async () => {
            ...
            setBalance(response.data.user.tokenBalance);
        };
    ...
    return (
        <div className="flex justify-center">
            <div className="w-full stats stats-vertical xl:stats-horizontal shadow bg-base-100">
                <div className="stat">
                ...
                <div className="stat">
                    ...
                    <div className="stat-title text-base">Interactions</div>
                    <div className="stat-value">25</div>
                    <div className="stat-desc">Like: Comment:</div>
                </div>
                ...
                <div className="stat">
                    ...
                    <div className="stat-title text-base">Tasks Completed</div>
